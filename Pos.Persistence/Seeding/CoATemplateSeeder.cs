    ...
    public static class CoATemplateSeeder
    {
        ...
        public static async Task SeedFromTemplateAsync(PosClientDbContext db)
        {
            ...
            var T = new List<Row>
            {
                ...
                new("411",  "Gross sales value",     AccountType.Income,  "41",  false, true,  NormalSide.Credit),
                ...
                new("5111", "Actual cost of sold stock",    AccountType.Expense, "511", false,true, NormalSide.Debit),
                new("5112", "Actual cost of returned stock",AccountType.Expense, "511", false,true, NormalSide.Debit),
                new("5119", "Cost/Price diff of PRet stock",AccountType.Expense, "511", false,true, NormalSide.Debit),

                new("512",  "Discounts",             AccountType.Expense, "51",  true,  false, NormalSide.Debit),
                new("5121", "Special discounts",      AccountType.Expense, "512", false,true, NormalSide.Debit),
                new("5122", "Special discount returned",AccountType.Expense,"512",false,true, NormalSide.Credit),
                new("5124", "Inv Offer Discount On Purchase",AccountType.Expense,"512",false,true, NormalSide.Credit),

                new("514",  "Expired stock actual value", AccountType.Expense, "51", false, true, NormalSide.Debit),
