...
namespace Pos.Domain.Services
{
    public interface IPurchasesService
    {
        ...
        Task<decimal> GetOnHandAsync(int itemId, InventoryLocationType target, int? outletId, int? warehouseId, CancellationToken ct = default);
        ...
        Task<IReadOnlyList<PurchasePayment>> GetPaymentsAsync(int purchaseId, CancellationToken ct = default);
